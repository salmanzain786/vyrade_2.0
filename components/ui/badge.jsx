  ...
  'inline-flex items-center rounded-md border px-2 py-0.5 text-xs font-medium transition-colors focus:outline-none',
  {
    variants: {
      variant: {
        ...
        success: 'border-transparent bg-[oklch(var(--success)/0.15)] text-[oklch(var(--success))]',
        warning: 'border-transparent bg-[oklch(var(--warning)/0.15)] text-[oklch(var(--warning))]',
